            ...
            {payment > 0 ? (
                <>
                    ...
                    {isFormValid && !isBookingConfirmed ? (
                        <Button variant="success" onClick={hanleConfirmBooking}>
                            {isProcessingPayment ? (
                                <>
                                    <span
                ...
                <p className="text-danger">Check-out date must be affter check-in date</p>
            )}
        </div>
    );
};
