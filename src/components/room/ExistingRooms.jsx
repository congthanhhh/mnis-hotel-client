...
const ExistingRooms = () => {
    ...
    // if not understand, review the tutorial pagination 'https://www.youtube.com/watch?v=wAGIOCqS8tk'
            ...
            {isLoading ? (
                ...
                <>
                    <section className="mt-5 mb-5 container">
                        <div className="d-flex justify-content-between mb-3 mt5">
                        ...
                        <RoomPaginator
                            ...
                            totalPages={calculateTotalPages(filteredRoom, roomPerPage, rooms)}
                            onePageChange={handlePaginationClick}
                        />
                    </section>
                </>
            )}
